...
@csrf
  <div class="col-sm-5">
    ...
    <input type="text" class="form-control" id="TEN_LOAISANPHAM" name="ten_loaisanpham">
  </div>
  <div class="col-sm-5">
    <label for="mota_loaisanpham" class="form-label" style="margin:10px">Mô tả loại sản phẩm</label>
    <input type="text" class="form-control" id="MOTA_LOAISANPHAM" name="mota_loaisanpham">
  </div>
